/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface BaseEnv` (hash: 3c0d13ff4fe27b7e434f5ebddf895a5c)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		db: D1Database;
		queue: Queue;
		virtualBrowser: Fetcher;
		AI: Ai;
		destinationEvaluationWorkflow: Workflow<Parameters<import("./src/index").DestinationEvaluationWorkflow['run']>[0]['payload']>;
	}
}
